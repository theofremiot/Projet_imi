...
# for i in range(np.shape(coord_mm)[0]):
#     alpha=P0[2][0]*coord_mm[i][0]+P0[2][1]*coord_mm[i][1]+P0[2][2]*coord_mm[i][2]+P0[2][3]
#     print(alpha)
...
# p3ds = []
# for uv1, uv2 in zip(imgpoints0[0], imgpoints1[0]):
...
# coord_cam_x = [coord[0] for coord in p3ds]
# coord_cam_y = [coord[1] for coord in p3ds]
# coord_cam_z = [coord[2] for coord in p3ds]
# ax = plt.axes(projection='3d')
# ax.scatter3D(coord_cam_x, coord_cam_y, coord_cam_z)
# ax.set_xlabel('z')
# ax.set_ylabel('x')
